...
from .additional_function import select_file, init_ori_ratio, show_image_to_label, select_directory
...
class MainController(QMainWindow):
    ...
    def open_image(self):  # function that program use
        ...
        for i in range(self.model.data_model.total_camera_used):
            ...
            if path_image:
                ...
                if path_parameter:
                    ...
                    print(self.model.data_model.data_config)
                    if not self.model.data_model.data_config:
                        self.model.update_intrinsic_parameter(i)
        ...
        if any(item is None for item in self.model.data_model.list_original_image) is False:
    ...
    def mouse_event_move(self, e):
        ...
        try:
            ...
            # if self.model.data_model.list_original_image[index] is not None:
    ...
    def get_position_in_image(self, e):
        ...
        try:
            ...
            if e.button() == Qt.MouseButton.LeftButton:
                pos_x = round(e.position().x() * ratio_x)
                pos_y = round(e.position().y() * ratio_y)
    ...
    def hide(self):
        ...
        """
        # self.main_ui.label_118.hide()
        self.main_ui.spinBox_width_dst_2.setEnabled(False)
        self.main_ui.spinBox_height_dst_2.setEnabled(False)
        self.main_ui.spinBox_width_dst_3.setEnabled(False)
        self.main_ui.spinBox_height_dst_3.setEnabled(False)
    ...
    def onclick_save_image(self):
        ...
        if self.model.data_model.overlap_image is not None and directory_path is not None:
            self.model.save_image(directory_path)
