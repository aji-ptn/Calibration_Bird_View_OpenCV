class ConfigurationImage4:
    def __init__(self, view_controller):
        ...
        self.view_controller.main_ui.doubleSpinBox_fy_3.setEnabled(False)
        self.connect_action()

    def connect_action(self):
        # ================== intrinsic parameter ==================
        self.view_controller.main_ui.doubleSpinBox_fx_3.valueChanged.connect(self.change_intrinsic_from_ui_fx_fy)
        self.view_controller.main_ui.doubleSpinBox_fy_3.valueChanged.connect(self.change_intrinsic_from_ui_fx_fy)
        self.view_controller.main_ui.doubleSpinBox_icx_3.valueChanged.connect(self.change_intrinsic_from_ui_icx_icy_w_h)
        self.view_controller.main_ui.doubleSpinBox_icy_3.valueChanged.connect(self.change_intrinsic_from_ui_icx_icy_w_h)
        self.view_controller.main_ui.spinBox_width_3.valueChanged.connect(self.change_intrinsic_from_ui_icx_icy_w_h)
        self.view_controller.main_ui.spinBox_height_3.valueChanged.connect(self.change_intrinsic_from_ui_icx_icy_w_h)
    ...
    def update_properties_intrinsic(self):
        self.view_controller.model.data_model.properties_image["Image_4"] = {}
        self.view_controller.model.data_model.properties_image["Image_4"]["Ins"] = {}
        self.update_properties_src()
        self.update_properties_dst()
        self.change_properties_intrinsic()

    def update_properties_src(self):
        self.view_controller.model.data_model.properties_image["Image_4"]["src"] = {}
        self.change_properties_src()

    def update_properties_dst(self):
        self.view_controller.model.data_model.properties_image["Image_4"]["dst"] = {}
        self.change_properties_dst()

    def change_intrinsic_from_ui_fx_fy(self):
        if self.view_controller.model.data_model.properties_image["Image_4"]["Ins"]["Fx"] is not None:
            print("here")
            deviation = self.view_controller.main_ui.doubleSpinBox_fx_3.value() - \
                        self.view_controller.model.data_model.properties_image["Image_4"]["Ins"]["Fx"]
            self.view_controller.model.data_model.properties_image["Image_4"]["Ins"]["Fy"] = self.view_controller.model.data_model.properties_image["Image_4"]["Ins"]["Fy"] - deviation
            self.view_controller.model.data_model.properties_image["Image_4"]["Ins"]["Fx"] = self.view_controller.main_ui.doubleSpinBox_fx_3.value()
    ...
    def set_intrinsic_parameter_to_ui(self):
        ...
        self.view_controller.main_ui.doubleSpinBox_fy_3.setValue(
            self.view_controller.model.data_model.properties_image["Image_4"]["Ins"]["Fy"])
        self.view_controller.main_ui.doubleSpinBox_icx_3.setValue(
            self.view_controller.model.data_model.properties_image["Image_4"]["Ins"]["Icx"])
        self.view_controller.main_ui.doubleSpinBox_icy_3.setValue(
            self.view_controller.model.data_model.properties_image["Image_4"]["Ins"]["Icy"])
        self.view_controller.main_ui.spinBox_width_3.setValue(
            self.view_controller.model.data_model.properties_image["Image_4"]["Ins"]["Width"])
        self.view_controller.main_ui.spinBox_height_3.setValue(
            self.view_controller.model.data_model.properties_image["Image_4"]["Ins"]["Height"])
    ...
    def set_properties_src_to_ui(self):
        ...
        self.view_controller.main_ui.spinBox_src_point1_x_3.setValue(
            self.view_controller.model.data_model.properties_image["Image_4"]["src"]["point1_x"])
        self.view_controller.main_ui.spinBox_src_point1_y_3.setValue(
            self.view_controller.model.data_model.properties_image["Image_4"]["src"]["point1_y"])
        self.view_controller.main_ui.spinBox_src_point2_x_3.setValue(
            self.view_controller.model.data_model.properties_image["Image_4"]["src"]["point2_x"])
        self.view_controller.main_ui.spinBox_src_point2_y_3.setValue(
            self.view_controller.model.data_model.properties_image["Image_4"]["src"]["point2_y"])
        self.view_controller.main_ui.spinBox_src_point3_x_3.setValue(
            self.view_controller.model.data_model.properties_image["Image_4"]["src"]["point3_x"])
        self.view_controller.main_ui.spinBox_src_point3_y_3.setValue(
            self.view_controller.model.data_model.properties_image["Image_4"]["src"]["point3_y"])
        self.view_controller.main_ui.spinBox_src_point4_x_3.setValue(
            self.view_controller.model.data_model.properties_image["Image_4"]["src"]["point4_x"])
        self.view_controller.main_ui.spinBox_src_point4_y_3.setValue(
            self.view_controller.model.data_model.properties_image["Image_4"]["src"]["point4_y"])
    ...
    def set_properties_dst_to_ui(self):
        ...
        self.view_controller.main_ui.spinBox_dst_point1_x_3.setValue(
            self.view_controller.model.data_model.properties_image["Image_4"]["dst"]["point1_x"])
        self.view_controller.main_ui.spinBox_dst_point1_y_3.setValue(
            self.view_controller.model.data_model.properties_image["Image_4"]["dst"]["point1_y"])
        self.view_controller.main_ui.spinBox_dst_point2_x_3.setValue(
            self.view_controller.model.data_model.properties_image["Image_4"]["dst"]["point2_x"])
        self.view_controller.main_ui.spinBox_dst_point2_y_3.setValue(
            self.view_controller.model.data_model.properties_image["Image_4"]["dst"]["point2_y"])
        self.view_controller.main_ui.spinBox_dst_point3_x_3.setValue(
            self.view_controller.model.data_model.properties_image["Image_4"]["dst"]["point3_x"])
        self.view_controller.main_ui.spinBox_dst_point3_y_3.setValue(
            self.view_controller.model.data_model.properties_image["Image_4"]["dst"]["point3_y"])
        self.view_controller.main_ui.spinBox_dst_point4_x_3.setValue(
            self.view_controller.model.data_model.properties_image["Image_4"]["dst"]["point4_x"])
        self.view_controller.main_ui.spinBox_dst_point4_y_3.setValue(
            self.view_controller.model.data_model.properties_image["Image_4"]["dst"]["point4_y"])
        self.view_controller.main_ui.spinBox_width_dst_3.setValue(
            self.view_controller.model.data_model.properties_image["Image_4"]["dst"]["Width"])
        self.view_controller.main_ui.spinBox_height_dst_3.setValue(
            self.view_controller.model.data_model.properties_image["Image_4"]["dst"]["Height"])
